...
/***/ function(module, exports, __webpack_require__) {
	...
	var _GuessWhoContainer = __webpack_require__(159);
	
	var _GuessWhoContainer2 = _interopRequireDefault(_GuessWhoContainer);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	window.onload = function () {
	  _reactDom2.default.render(_react2.default.createElement(_GuessWhoContainer2.default, null), document.getElementById('app'));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GuessWhoContainer = function (_React$Component) {
	  _inherits(GuessWhoContainer, _React$Component);
	
	  function GuessWhoContainer(props) {
	    _classCallCheck(this, GuessWhoContainer);
	
	    var _this = _possibleConstructorReturn(this, (GuessWhoContainer.__proto__ || Object.getPrototypeOf(GuessWhoContainer)).call(this, props));
	    ...
	    console.log('grid2', _this.state.grid2);
	    return _this;
	  }
	
	  _createClass(GuessWhoContainer, [{
	    ...
	    value: function handleCharacterClick(event) {
	      ...
	      try {
	        for (var _iterator = crosses[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	          var cross = _step.value;
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(_Board2.default, (_React$createElement = {
	          grid: this.state.grid
	        }, _defineProperty(_React$createElement, 'grid', this.state.grid2), _defineProperty(_React$createElement, 'handleCharacterClick', this.handleCharacterClick), _React$createElement))
	      );
	    }
	  }]);
	
	  return GuessWhoContainer;
	}(_react2.default.Component);
	
	exports.default = GuessWhoContainer;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PlayerCard = __webpack_require__(162);
	...
	var Board = function Board(props) {
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(_Character2.default, { characters: props, onClick: props.handleCharacterClick }),
	    _react2.default.createElement(_PlayerCard2.default, { card: props })
	  );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Character = function Character(props) {
	  ...
	  var characters = props.characters.grid.map(function (character, index) {
	    return _react2.default.createElement(
	      'tr',
	      null,
	      _react2.default.createElement('img', { className: 'character', key: index, src: character.image, onClick: props.onClick }),
	      _react2.default.createElement('img', { className: 'cross', src: character.cross })
	    );
	  });
	  return _react2.default.createElement(
	    'div',
	    { className: 'character_table' },
	    characters
	  );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PlayerCard = function PlayerCard(props) {
	  var player2card = void 0;
	  var player1card = props.card.grid[Math.floor(Math.random() * props.card.grid.length)];
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement('img', { src: player1card.image })
	  );
	};
